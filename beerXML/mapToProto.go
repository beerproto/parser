...
func ToProtoRecipeType(i *beerXML.Recipe, s *beerXML.Style) *beerproto.RecipeType {
	return &beerproto.RecipeType{
		...
		ColorEstimate: ToProtoColorTypeFromFloat(s.Colormax),
		// BeerPH:              ToProtoAcidityType(i.BeerPH),
		Name:            i.Name,
		Type:            ToProtoRecipeTypeType(i.Type),
		Coauthor:        i.AsstBrewer,
		OriginalGravity: ToProtoGravityTypeFromFloat(s.OGMAX),
		FinalGravity:    ToProtoGravityTypeFromFloat(s.FGMAX),
		...
		Notes:           i.Notes,
		AlcoholByVolume: ToProtoPercentTypeFromFloat(s.ABVMAX),
...
func ToProtoSpecificHeatUnitType(i *beerjson.SpecificHeatUnitType) beerproto.SpecificHeatUnitType {
	if i == nil {
		return beerproto.SpecificHeatUnitType_NULL_SPECIFICHEATUNITTYPE
	}

	unit := beerproto.SpecificHeatUnitType_value[strings.ToUpper(string(*i))]
	return beerproto.SpecificHeatUnitType(unit)
}
...
func ToProtoCultureInformation(i beerXML.Yeast) *beerproto.CultureInformation {
	return &beerproto.CultureInformation{
		Form:             ToProtoCultureBaseFormFromString(i.Form),
		...
		Type:             ToProtoCultureBaseTypeFromString(i.Type),
		Flocculation:     ToProtoQualitativeRangeType(i.Flocculation),
		AttenuationRange: ToProtoPercentRangeType(i.Attenuation, i.Attenuation),
...
func ToProtoQualitativeRangeType(i string) beerproto.QualitativeRangeType {
	if i == "" {
		return beerproto.QualitativeRangeType_NULL_QUALITATIVERANGETYPE
	}
	if unit, ok := beerproto.QualitativeRangeType_value[strings.ReplaceAll(strings.ToUpper(i), " ", "_")]; ok {
		return beerproto.QualitativeRangeType(unit)
	}
	return beerproto.QualitativeRangeType_NULL_QUALITATIVERANGETYPE
}

func ToProtoCultureBaseTypeFromString(i string) beerproto.CultureBaseType {
	if i == "" {
...
func ToProtoCultureBaseType(i *beerjson.CultureBaseType) beerproto.CultureBaseType {
	...
	if unit, ok := beerproto.CultureBaseType_value[strings.ToUpper(v)]; ok {
		return beerproto.CultureBaseType(unit)
	}
...
func ToProtoDiastaticPowerUnitType(i *beerjson.DiastaticPowerUnitType) beerproto.DiastaticPowerUnitType {
	if i == nil {
		return beerproto.DiastaticPowerUnitType_NULL_DIASTATICPOWERUNITTYPE
	}

	unit := beerproto.DiastaticPowerUnitType_value[strings.ToUpper(string(*i))]
	return beerproto.DiastaticPowerUnitType(unit)
}
...
func ToProtoColorRangeType(max, min float32) *beerproto.ColorRangeType {
	...
	return &beerproto.ColorRangeType{
		Minimum: ToProtoColorTypeFromFloat(min),
		Maximum: ToProtoColorTypeFromFloat(max),
	}
}
...
func ToProtoGravityRangeType(max, min float32) *beerproto.GravityRangeType {
	...
	return &beerproto.GravityRangeType{
		Minimum: ToProtoGravityTypeFromFloat(min),
		Maximum: ToProtoGravityTypeFromFloat(max),
	}
}
...
func ToProtoPercentRangeType(max, min float32) *beerproto.PercentRangeType {
	...
	return &beerproto.PercentRangeType{
		Minimum: ToProtoPercentTypeFromFloat(min),
		Maximum: ToProtoPercentTypeFromFloat(max),
	}
}
...
func ToProtoCultureBaseFormFromString(i string) beerproto.CultureBaseForm {
	v := beerjson.CultureBaseForm(i)
	return ToProtoCultureBaseForm(&v)
}
...
func ToProtoCultureBaseForm(i *beerjson.CultureBaseForm) beerproto.CultureBaseForm {
	...
	unit := beerproto.CultureBaseForm_value[strings.ToUpper(v)]
...
func ToProtoUnitUnitType(i beerjson.UnitUnitType) beerproto.UnitUnitType {
	unit := beerproto.UnitUnitType_value[strings.ToUpper(string(i))]
...
func ToProtoMassUnitType(i beerjson.MassUnitType) beerproto.MassUnitType {
	unit := beerproto.MassUnitType_value[strings.ToUpper(string(i))]
	return beerproto.MassUnitType(unit)
}
...
func ToProtoUseType(i *beerjson.UseType) beerproto.UseType {
	if i == nil {
		return beerproto.UseType_NULL_USETYPE
	}
...
func ToProtoGravityTypeFromFloat(i float32) *beerproto.GravityType {
...
func ToProtoGravityUnitType(i beerjson.GravityUnitType) beerproto.GravityUnitType {
	unit := beerproto.GravityUnitType_value[strings.ToUpper(string(i))]
	return beerproto.GravityUnitType(unit)
}
...
func ToProtoRecipeTypeType(i string) beerproto.RecipeType_RecipeTypeType {
	...
	return beerproto.RecipeType_NULL_RECIPETYPETYPE
}


func ToProtoColorTypeFromFloat(i float32) *beerproto.ColorType {
...
func ToProtoColorUnitType(i beerjson.ColorUnitType) beerproto.ColorUnitType {
	unit := beerproto.ColorUnitType_value[strings.ToUpper(string(i))]

	return beerproto.ColorUnitType(unit)
}
...
func ToProtoRecipeStyleType_StyleCategories(i string) beerproto.RecipeStyleType_StyleCategories {
	if i == "" {
		return beerproto.RecipeStyleType_NULL_STYLECATEGORIES
	}
...
func ToProtoPercentTypeFromFloat(i float32) *beerproto.PercentType {
...
func ToProtoMashProcedureType(i *beerXML.Mash) *beerproto.MashProcedureType {
	...
	if i.Spargetemp > 0 {
		...
		sparge.StartPh = ToProtoAcidityTypeFromFloat(i.PH)
...
func ToProtoMashStepType(i beerXML.MashStep) *beerproto.MashStepType {
	...
	mashStep := &beerproto.MashStepType{
		StepTime:        ToProtoTimeTypeFromInt(i.Steptime),
		RampTime:        ToProtoTimeTypeFromInt(i.Ramptime),
		EndTemperature:  ToProtoTemperatureType(i.Endtemp),
		Description:     i.Description,
		Name:            i.Name,
		Type:            t,
		StepTemperature: ToProtoTemperatureType(i.Steptemp),
		WaterGrainRatio: ToProtoSpecificVolumeTypeFromFloat(i.Infuseamount),
	}
...
func ToProtoAcidityTypeFromFloat(i float32) *beerproto.AcidityType {
...
func ToProtoAcidityUnitType(i beerjson.AcidityUnitType) beerproto.AcidityUnitType {
	unit := beerproto.AcidityUnitType_value[strings.ToUpper(string(i))]
	return beerproto.AcidityUnitType(unit)
}

func ToProtoTimeTypeFromInt(i int64) *beerproto.TimeType {
...
func ToProtoTemperatureUnitType(i beerjson.TemperatureUnitType) beerproto.TemperatureUnitType {
	unit := beerproto.TemperatureUnitType_value[strings.ToUpper(string(i))]
	return beerproto.TemperatureUnitType(unit)
}
